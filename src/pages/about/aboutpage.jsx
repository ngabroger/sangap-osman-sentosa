          ...
          <div className="flex flex-col md:flex-row items-center max-w-screen-xl justify-between h-1/2 p-4  md:p-12 mx-auto">
            <div className="md:w-1/2">
              <p className="text-justify font-primaryRegular md:text-start  ">
                ...
                Sejak awal berdirinya, perusahaan ini telah memfokuskan diri
                pada inovasi dan kualitas produk, menghadirkan solusi terbaik
                bagi kebutuhan pelanggan. Dengan dedikasi terhadap keunggulan,
                PT SANGAP OSMAN SENTOSA terus berkembang dan memperluas lini
                produknya, mencakup berbagai sektor mulai dari bahan konstruksi
                hingga pelapis cat dan perekat.
                <br />
                Komitmen perusahaan terhadap inovasi dibuktikan dengan
                peluncuran berbagai produk unggulan yang dirancang untuk
                memenuhi standar kualitas tertinggi. Dalam perjalanannya,
                perusahaan telah bermitra dengan berbagai perusahaan besar dan
                berkontribusi pada proyek-proyek berskala nasional
              </p>
            </div>
